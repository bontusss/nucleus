...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/org/branch/{branch_id}/{org_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/tenant/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Login credentials (email)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/tenant/register": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Register credentials (email and password)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.RegisterTenantRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/user.UserRoleAssignmentResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/user.AuditLogResponse"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.CreatePermissionRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.CheckUserPermissionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.UpdatePermissionRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/user.RoleHierarchyResponse"
                            }
                        }
                    },
                    "401": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/user.RolePermissionResponse"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.GrantPermissionRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/store.storeParams"
                        }
                    }
                ],
                "responses": {
        ...
        "/users/{id}/permissions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Include role hierarchy (default: true)",
                        "name": "hierarchy",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/user.UserPermissionResponse"
                            }
                        }
                    },
                    "400": {
        ...
        "/users/{id}/roles/{role_id}": {
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Business ID scope",
                        "name": "business_id",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Branch ID scope",
                        "name": "branch_id",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "user.CheckUserPermissionRequest": {
            "type": "object",
            "required": [
                "code",
                "tenant_id",
        ...
        "user.UserResponse": {
            ...
            "properties": {
                ...
                "is_active": {
                    "description": "Timezone      string                 ` + "`" + `json:\"timezone\"` + "`" + `\nLanguage      string                 ` + "`" + `json:\"language\"` + "`" + `",
                    "type": "boolean"
                },
                "last_login_at": {
                    "type": "string"
        ...
        "user.UserRoleAssignmentResponse": {
            "type": "object",
            "properties": {
                "assigned_at": {
                    "type": "string"
